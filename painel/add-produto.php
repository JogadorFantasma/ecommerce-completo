                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <label class="mr-sm-2" for="">Quantidade Estoque</label>
                                                    <input type="number" class="form-control" name="quantidade_estoque" value="1" >
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Avise Estoque Baixo</label>
                                                    <input type="number" class="form-control" name="avise_estoque" value="0" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <label class="mr-sm-2" for="">Preço de</label>
                                                    <input type="text" class="form-control" name="preco_de">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Preço por</label>
                                                    <input type="text" class="form-control" name="preco_por">
                                                </div>
                                            </div>
                                             <div class="col-md-6">
                                                <div class="form-group">
